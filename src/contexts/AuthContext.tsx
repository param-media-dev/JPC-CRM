        ...
        try {
          ...
          if (userDoc.exists()) {
            ...
            try {
              ...
              handleFirestoreError(writeError, OperationType.WRITE, `jpc_users/${fUser.uid}`);
            }
          }
        } catch (error) {
          // Only log and handle if it wasn't already handled by the inner catch
          if (error instanceof Error && !error.message.includes('jpc_users/')) {
