...
// For Vercel, we need to export the app but NOT call listen if VERCEL is true.
// Also, we don't start the Vite middleware if we're on Vercel as it handles static files.
if (process.env.NODE_ENV !== 'production' && !process.env.VERCEL) {
  ...
  // In regular production (non-Vercel), serve the static files
...
// Start server if not in a Vercel/Serverless environment
